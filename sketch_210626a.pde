...
int mirror =0;
int mirrorn =-1;
PImage Done,VR,Paint,LED_Toggle,LED_on,LED_off;
...
//__End of variable declaration___//


//Function to load all the images from data folder of the sketch//
void loadImages()
{
  Done = loadImage("D:/Done.png"); 
  VR = loadImage ("D:/back.jpg");
  Paint = loadImage("D:/Paint.png");
  LED_Toggle = loadImage("D:/LED_Toggle.png");
  LED_on = loadImage("D:/LED_on.png");
  LED_off = loadImage ("D:/LED_off.png");
}
//__End of variable declaration___//
...
//__End of main screen function___//
...
//__End of main Paintscreen function___//
...
//__End of main LEDscreen function__//
